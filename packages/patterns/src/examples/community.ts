      ...
      steps: [
        {
          ...
          payloadData: { rating: 4, text: "great tacos" },
        },
        {
          name: "Persist",
          channelId: "ch-persist",
          fromNode: "APIGateway",
          payloadType: "CreateReview",
          payloadData: { restaurantId: "r1" },
        },
        {
          name: "Update Rating",
          channelId: "ch-rating",
          fromNode: "ReviewService",
          payloadType: "UpdateAvg",
          payloadData: { restaurantId: "r1", avg: 4.2 },
        },
      ],
    },
    {
      ...
      steps: [
        {
          ...
          channelId: "ch-search",
          fromNode: "Client",
          payloadType: "NearbySearch",
          payloadData: { lat: 37.7, lng: -122.4 },
        },
        {
          name: "Return Results",
          visuals: [{ kind: "signal", targetId: "GeoIndex", color: "green" }],
        },
      ],
    },
  ],
  ...
  scenarios: [
      ...
      steps: [
        {
          ...
          channelId: "ch-score",
          fromNode: "GameClient",
          payloadType: "SubmitScore",
          payloadData: { score: 12500 },
        },
        {
          name: "Update Rank",
          channelId: "ch-update",
          fromNode: "ScoreGateway",
          payloadType: "UpdateScore",
          payloadData: { playerId: "p1" },
        },
        {
          name: "ZADD Shard",
          channelId: "ch-shard",
          fromNode: "LeaderboardService",
          payloadType: "ZAdd",
          payloadData: { score: 12500 },
        },
      ],
    },
    {
      ...
      steps: [
        ...
        {
          name: "Return Leaders",
          visuals: [{ kind: "signal", targetId: "LeaderboardShardA", color: "green" }],
        },
      ],
    },
    {
      ...
      steps: [
        ...
        {
          name: "Persist",
          channelId: "ch-snapshot",
          fromNode: "SnapshotService",
          payloadType: "SaveSnapshot",
          payloadData: { board: "global" },
        },
      ],
    },
  ],
...
export const donationsWebsiteExample = defineExample({
  ...
  difficulty: "community",
  description:
    "Charity donation platform with payment processing, campaign tracking, and receipts.",
      ...
      steps: [
        {
          ...
          fromNode: "DonorApp",
          payloadType: "Donate",
          payloadData: { amount: 50, campaignId: "c1" },
        },
        {
          ...
          payloadData: { donationId: "d1" },
        },
        {
          name: "Update Campaign",
          channelId: "ch-campaign",
          fromNode: "DonationService",
          payloadType: "IncrementTotal",
          payloadData: { campaignId: "c1", amount: 50 },
        },
      ],
    },
    {
      ...
      steps: [
        {
          ...
          channelId: "ch-pay",
          fromNode: "DonationService",
          payloadType: "ChargeEvent",
          payloadData: { donationId: "d1" },
        },
        {
          name: "Stripe Charge",
          description: "Payment processed via Stripe",
          visuals: [{ kind: "signal", targetId: "StripeConnector", color: "green" }],
        },
      ],
    },
    {
      ...
      steps: [
        {
          ...
          channelId: "ch-receipt",
          fromNode: "PaymentService",
          payloadType: "SendReceipt",
          payloadData: { email: "donor@example.com" },
        },
      ],
    },
  ],
...
export const githubActionsExample = defineExample({
  ...
  difficulty: "community",
  description:
    "CI/CD pipeline runner with workflow dispatch, job queue, and containerized execution.",
  ...
  scenarios: [
      ...
      steps: [
        {
          ...
          channelId: "ch-push",
          fromNode: "GitPush",
          payloadType: "PushEvent",
          payloadData: { branch: "main", commit: "abc123" },
        },
        {
          name: "Match Workflow",
          channelId: "ch-trigger",
          fromNode: "WebhookReceiver",
          payloadType: "TriggerWorkflow",
          payloadData: { workflow: "ci.yml" },
        },
        {
          name: "Dispatch Jobs",
          channelId: "ch-dispatch",
          fromNode: "WorkflowEngine",
          payloadType: "DispatchJobs",
          payloadData: { jobs: ["build", "test"] },
        },
      ],
    },
    {
      ...
      steps: [
        {
          name: "Pick Job",
          description: "Runner picks job from queue",
          visuals: [{ kind: "signal", targetId: "RunnerPool", color: "green" }],
        },
        {
          name: "Run in Container",
          description: "Job executes in isolated container",
          visuals: [{ kind: "highlight", targetId: "RunnerPool", color: "yellow" }],
        },
        {
          name: "Stream Logs",
          channelId: "ch-logs",
    ...
    },
    {
      ...
      steps: [
        {
          name: "Build Complete",
          channelId: "ch-artifact",
          fromNode: "RunnerPool",
          payloadType: "UploadArtifact",
          payloadData: { name: "dist.zip" },
        },
        {
          name: "Update Status",
          channelId: "ch-status",
          fromNode: "WorkflowEngine",
          payloadType: "JobComplete",
          payloadData: { job: "build", status: "success" },
        },
      ],
    },
  ],
