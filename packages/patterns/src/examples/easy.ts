      ...
      steps: [
        {
          name: "Client Request",
          channelId: "ch3",
          fromNode: "LoadBalancer",
          payloadType: "ShortenURL",
        ...
        },
        {
          ...
          channelId: "ch-db",
          fromNode: "URLService",
          payloadType: "StoreMapping",
          payloadData: { shortCode: "abc123" },
          visuals: [{ kind: "highlight", targetId: "PrimaryDB", color: "yellow" }],
        },
        {
          name: "Populate Cache",
          channelId: "ch-cache",
          fromNode: "URLService",
          payloadType: "CacheWrite",
          payloadData: { shortCode: "abc123" },
          visuals: [{ kind: "signal", targetId: "RedisCache", color: "green" }],
        },
      ],
    },
    {
      ...
      steps: [
        ...
        },
        {
          ...
          channelId: "ch-cache",
          fromNode: "URLService",
          payloadType: "CacheHit",
          payloadData: { longUrl: "https://example.com" },
          visuals: [{ kind: "signal", targetId: "RedisCache", color: "green", label: "HIT" }],
        },
        {
          name: "302 Redirect",
          description: "Return redirect without touching DB",
          visuals: [{ kind: "signal", targetId: "Client", color: "green", label: "302" }],
        },
      ],
    },
    {
      ...
      steps: [
        {
          ...
          fromNode: "LoadBalancer",
          payloadType: "ResolveURL",
          payloadData: { shortCode: "xyz789" },
        },
        {
          name: "Cache Miss",
          channelId: "ch-cache",
          fromNode: "URLService",
          visuals: [{ kind: "barrier", targetId: "RedisCache", color: "yellow", label: "MISS" }],
        },
        {
          name: "Read Through DB",
          channelId: "ch-db",
          fromNode: "URLService",
          payloadType: "DBLookup",
          payloadData: { shortCode: "xyz789" },
          visuals: [{ kind: "signal", targetId: "PrimaryDB", color: "green" }],
        },
        {
          name: "Populate Cache",
          channelId: "ch-cache",
          fromNode: "URLService",
          visuals: [
            { kind: "highlight", targetId: "RedisCache", color: "yellow", label: "Warm cache" },
          ],
        },
      ],
    },
      ...
      steps: [
        {
          ...
          channelId: "ch-upload",
          fromNode: "DesktopClient",
          payloadType: "PresignUpload",
          payloadData: { fileId: "f1" },
        },
        {
          name: "PUT Chunks to S3",
          channelId: "ch-blob",
          fromNode: "DesktopClient",
          payloadType: "PutBlob",
      ...
      steps: [
        {
          name: "File Changed",
          channelId: "ch-event",
          fromNode: "MetadataService",
          payloadType: "FileChanged",
          payloadData: { fileId: "f1" },
        },
        {
          name: "Push Notification",
          channelId: "ch-push",
          fromNode: "SyncNotification",
          payloadType: "SyncPush",
          payloadData: { fileId: "f1" },
          visuals: [{ kind: "signal", targetId: "MobileClient", color: "green" }],
        },
      ],
    },
    {
      ...
      steps: [
        {
          ...
          description: "Two clients edit same file with different versions",
          visuals: [
            { kind: "highlight", targetId: "MetadataService", color: "yellow", label: "Conflict" },
          ],
        },
        {
          name: "Version Check",
          channelId: "ch-meta",
          fromNode: "APIGateway",
          payloadType: "VersionCheck",
          payloadData: { version: 2 },
        },
        {
          name: "Conflict Copy",
          description: "CAS commit fails; server keeps both versions instead of last-write-wins",
          visuals: [{ kind: "signal", targetId: "MetadataDB", color: "green" }],
        },
      ],
    },
  ],
  ...
  scenarios: [
    {
      ...
      steps: [
        ...
        },
        {
          ...
          payloadType: "GeoQuery",
          payloadData: { radius: "5km" },
        },
        {
          name: "Return Results",
      ...
      steps: [
        {
          ...
          channelId: "ch-review",
          fromNode: "APIGateway",
          payloadType: "SubmitReview",
          payloadData: { rating: 5 },
        },
        {
          name: "Persist Review",
          channelId: "ch-db",
          fromNode: "ReviewService",
          payloadType: "StoreReview",
          payloadData: { businessId: "b1" },
        },
        {
          name: "Async Reindex",
          channelId: "ch-reindex",
          fromNode: "ReviewService",
          payloadType: "ReindexBusiness",
          payloadData: { businessId: "b1" },
          visuals: [
            { kind: "lag", targetId: "GeoIndex", color: "yellow", label: "Reindex pending" },
          ],
        },
      ],
    },
      ...
      steps: [
        {
          name: "Place Order",
          channelId: "ch-order",
          fromNode: "CustomerApp",
          payloadType: "PlaceOrder",
          payloadData: { items: 3 },
        },
        {
          name: "Create Order",
        ...
        },
        {
          ...
          payloadType: "AssignDriver",
          payloadData: { driverId: "d1" },
        },
      ],
    },
    {
      ...
      steps: [
        ...
        },
        {
          ...
          visuals: [{ kind: "signal", targetId: "LocationService", color: "green" }],
        },
        {
          name: "Customer Polls",
          description: "Customer app receives updated driver position",
          visuals: [{ kind: "signal", targetId: "CustomerApp", color: "green" }],
        },
      ],
    },
    {
